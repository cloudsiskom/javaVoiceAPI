 ...
 */
@JsonDeserialize(using = Data10IsActive.Data10IsActiveDeserializer.class)
public abstract class Data10IsActive {
     ...
     */
    public static Data10IsActive fromNumber(Integer number) {
     ...
     */
    public static Data10IsActive fromMString(String mString) {
    ...
    @TypeCombinatorCase
    private static class NumberCase extends Data10IsActive {
    ...
    @TypeCombinatorCase
    private static class MStringCase extends Data10IsActive {
    ...
    /**
     * This is a custom deserializer class for Data10IsActive.
     */
    protected static class Data10IsActiveDeserializer
            extends JsonDeserializer<Data10IsActive> {

        @Override
        public Data10IsActive deserialize(JsonParser jp, DeserializationContext ctxt)
